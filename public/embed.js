(function(){
  ...
  var room=attr("data-room")||(location.hostname+location.pathname);
  ...
  var showLogin=attr("data-show-login")!=="false";
  ...
  function connect(){
    ...
    var wsUrl=proto+"//"+ORIGIN.replace(new RegExp("^https?://"),"")+"/ws?room="+encodeURIComponent(room);
  ...
  function updatePresence(){
    ...
    var pa=document.getElementById("lc-pa");if(!pa)return;
    var nd=document.getElementById("lc-nd");
    var authEl=document.getElementById("lc-auth");
    pa.innerHTML="";
    ...
    vis.forEach(function(u,i){
      if(u.avatar){var a=document.createElement("a");a.className="lc-p-avatar";a.href=u.url;a.target="_blank";a.title=u.username;a.style.zIndex=String(100-i);var im=document.createElement("img");im.src=u.avatar;im.alt=u.username;a.appendChild(im);pa.appendChild(a);}
    ...
    if(selfUser){
      ...
      if(selfUser.avatar){var av=document.createElement("img");av.src=selfUser.avatar;av.alt=selfUser.username;logoutBtn.appendChild(av);}
