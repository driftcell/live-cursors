...
.nav-divider{width:1px;height:20px;background:rgba(0,0,0,.1);margin:0 8px;flex-shrink:0}
...
<header>
  ...
  <nav>
    ...
    <div class="nav-divider" id="navDivider" style="display:none"></div>
...
(function(){
  ...
  presenceEl.innerHTML = '<div class="presence-avatars" id="presenceAvatars"></div>';
  ...
  function updatePresenceBar() {
    ...
    if (divider) divider.style.display = arr.length > 0 ? "" : "none";
  }
